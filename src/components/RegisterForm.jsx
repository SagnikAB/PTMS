    ...
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-80px)] px-4 py-12">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl border border-stone-200 shadow-md space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            <label className="block font-bold text-[#283845] mb-1 uppercase tracking-wider">
              Full Name
            </label>
            <div className="relative">
              <User className="w-4 h-4 text-[#283845] absolute left-3 top-1/2 -translate-y-1/2" />
              <input
                type="text"
                name="name"
                required
        ...
        <div className="text-center text-xs text-stone-600 border-t border-stone-200 pt-4">
          Already registered?{' '}
          <Link to="/login" className="font-bold text-[#283845] hover:text-[#FFA649] underline transition-colors">
